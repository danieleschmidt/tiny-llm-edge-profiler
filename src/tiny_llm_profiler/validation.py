...
class ModelValidator:
    ...
    def _validate_platform_compatibility(self, model: QuantizedModel, platform: str) -> List[ValidationIssue]:
    ...
    def _validate_performance_expectations(self, model: QuantizedModel, platform: str) -> List[ValidationIssue]:
    ...
    def _estimate_performance(self, model: QuantizedModel, platform: str) -> float:
        ...
        base_performance = 50.0 / max(model.size_mb, 0.1)  # Inverse relationship with size
...
class RobustProfilingWrapper:
    ...
    def robust_profile(
        ...
        **kwargs
        ...
        self.logger.error(f"All profiling attempts failed. Last error: {last_exception}")
