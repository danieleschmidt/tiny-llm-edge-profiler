...
class JSONFormatter(logging.Formatter):
    ...
    def format(self, record: logging.LogRecord) -> str:
        ...
        if self.include_extra:
            extra_fields = [
                'platform', 'model_name', 'device_path', 'operation', 
                'duration', 'metrics', 'profiling_session_id'
            ]
...
class ContextAwareLogger:
    ...
    def exception(self, message: str, exception: Optional[Exception] = None, **kwargs) -> None:
...
class PerformanceLogger:
    ...
    def log_profiling_start(self, platform: str, model_name: str, session_id: str, **kwargs) -> None:
    ...
    def log_profiling_end(self, session_id: str, duration_seconds: float, results_summary: Dict[str, Any]) -> None:
    ...
    def log_device_event(self, event_type: str, platform: str, device_path: str, **kwargs) -> None:
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        ...
        if exc_type and issubclass(exc_type, Exception):
            self.logger.exception(
                f"Exception in logging context: {exc_type.__name__}",
                exception=exc_val
            )
